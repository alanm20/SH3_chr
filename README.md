...
5. select "weight source" mesh and hold down shift and select one new oufit mesh. Switch to weight paint mode and click on "Weights" menu drop down and select "Transfer weights" menu item.
